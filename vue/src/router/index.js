  ...
  routes: [
    { path: '/', redirect: '/front/home' },
    {
      ...
      children: [
        ...
        { path: 'questionBankManage', meta: { name: 'AI题库管理' }, component: () => import('@/views/manager/QuestionBankManage.vue'), },
    ...
    },
    {
      ...
      children: [
        ...
        { path: 'interviewHistory', component: () => import('@/views/front/InterviewHistory.vue'),  },
        { path: 'employ', component: () => import('@/views/front/Employ.vue'),  },
        { path: 'search', component: () => import('@/views/front/Search.vue'),  },
        { path: 'aimock', component: () => import('@/views/front/AiMockInterview.vue'),  },
      ]
    },
